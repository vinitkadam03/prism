...
function processSpanAttributes(array $prismAttrs): array
{
    ...
    $processor = new OpenInferenceBatchSpanProcessor($exporter, Clock::getDefault());
 ...
 */
function processSpanData(SpanData $spanData): array
{
...
describe('Metadata Mapping', function (): void {
    ...
    it('maps tags to tag.tags', function (): void {
        ...
        $tags = json_decode((string) $attrs['tag.tags'], true);
